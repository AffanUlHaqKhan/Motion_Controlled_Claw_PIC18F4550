This projects includes use of servo motor control and 3-axis IMU sensor. Claw movement is controlled with repect to the hand movement using the IMU sensor.
